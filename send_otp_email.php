 ...
 * send_otp_email.php
 */
// config for email i will change it to dotenv soon
...
function sendOtpEmail(mysqli $conn, int $userId, string $toEmail, string $toName, string $purpose = '2fa'): bool
{
  ...
  $ins = $conn->prepare("INSERT INTO email_otps (user_id, otp_hash, purpose, expires_at) VALUES (?, ?, ?, DATE_ADD(NOW(), INTERVAL 10 MINUTE))");
